...
- You must follow all the [structured data guidelines](/search/docs/appearance/structured-data/sd-policies) and [Search Essentials](/search/docs/essentials).
...
- If your website aggregates fact-check articles, ensure that all articles match the [criteria](#guidelines) and that you provide an open and publicly available list of all fact-check websites you aggregate.
